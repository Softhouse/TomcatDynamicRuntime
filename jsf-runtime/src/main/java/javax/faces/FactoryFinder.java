...
//        System.err.println("Classloader hash: " + classLoader.hashCode());
//        System.err.println("Getting factory: " + factoryName + ", cache size: " + FACTORIES_CACHE.applicationMap.size());
    ...
    public static void setFactory(String factoryName,
        ...
        FactoryManager manager =
              FACTORIES_CACHE.getApplicationFactoryManager(classLoader);
        manager.addFactory(factoryName, implName, classLoader);
    ...
    public static void releaseFactories() throws FacesException {
       ...
       // System.err.println("Clearing all JSF factories...");
        FACTORIES_CACHE.applicationMap.clear();
    ...
    private static ClassLoader getClassLoader() throws FacesException {
    	...
    	// Use Class loader overrride from TDR deploy mechanism
    	ClassLoader scCL = (ClassLoader) TLSReference.get("TDRServletContextCL");
    	if ( scCL != null ) {
    		return scCL;
    	}
    ...
    private static final class FactoryManager {
        ...
        public void addFactory(String factoryName, String implementation, ClassLoader classLoader) {
            ...
            try {
                if (result instanceof List) {
                	...
                	// Make it possible to dynamically add new factories on-the-fly
                	//
                	factories.put(factoryName, getImplGivenPreviousImpl(classLoader, factoryName, implementation, result));
                }
            } finally {
        ...
        public Object getFactory(ClassLoader cl, String factoryName) {
        	...
        	// System.err.println("Defined factories: " + factories.get(factoryName));
